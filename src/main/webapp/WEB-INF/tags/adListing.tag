...
</c:url>"><img src="/images/image5.png" width="20" height="19" border="0" align="middle"></a> <a href="<c:url value="${pageContext.request.requestURL}">
<c:param name="sort" value="subject"/>
<c:param name="dir" value="desc"/>
</c:url>"><img src="/images/image6.png" width="20" height="19" border="0" align="middle"></a>
            </td>
